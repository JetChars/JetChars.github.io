...
ipmitool -H 172.16.3.104 -U root -P 123456 lan set 1 ipsrc static
ipmitool -H 172.16.3.104 -U root -P 123456 lan set 1 ipaddr 192.0.2.104
ipmitool -H 172.16.3.104 -U root -P 123456 lan set 1 netmask 255.255.255.0
ipmitool -H 172.16.3.104 -U root -P 123456 lan set 1 defgw ipaddr 192.0.2.1

ipmitool lan set 2 ipsrc static
ipmitool lan set 2 ipaddr 192.0.2.103
ipmitool lan set 2 netmask 255.255.255.0
ipmitool lan set 2 defgw ipaddr 192.0.2.1

ipmitool chassis bootdev disk/pxe/cdrom/bios
